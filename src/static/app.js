  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Build participants list HTML (show friendly message if none)
        ...
        if (details.participants && details.participants.length) {
          ...
          participantsHtml = `<ul class="participants-list"><li class="participant-item no-participants">No participants yet</li></ul>`;
        }
